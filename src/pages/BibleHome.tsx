...
export default function BibleHome() {
  ...
  return (
    <div className="min-h-screen min-h-[100dvh] flex flex-col bg-white overflow-x-hidden w-full max-w-full">
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-2 xs:px-3 min-375:px-4 sm:px-6 py-3 xs:py-4 min-390:py-5 sm:py-8 pb-[max(8.3rem,calc(env(safe-area-inset-bottom)+7.95rem))] overflow-x-hidden w-full box-border">
